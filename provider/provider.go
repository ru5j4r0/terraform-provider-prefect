...
import (
	...
	"github.com/ru5j4r0/terraform-provider-prefect/provider/datasources"
	"github.com/ru5j4r0/terraform-provider-prefect/provider/resources"
)
...
func (p *PrefectProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError(
			...
			fmt.Sprintf("An unexpected error occurred when creating the Prefect API client. This is a bug in the provider, please create an issue against https://github.com/ru5j4r0/terraform-provider-prefect unless it has already been reported. "+
